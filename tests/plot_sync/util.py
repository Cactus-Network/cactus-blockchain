...
from cactus.util.misc import SplitAsyncManager, split_async_manager
...
def get_dummy_connection(node_type: NodeType, peer_id: bytes32) -> WSCactusConnectionDummy:
    return WSCactusConnectionDummy(node_type, peer_id)
