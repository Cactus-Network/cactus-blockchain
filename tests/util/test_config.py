...
from cactus.util.config import get_unresolved_peer_infos, set_peer_info
...
@datacases(
    ...
    GetUnresolvedPeerInfosCase(
        ...
        expected_peer_infos={
            UnresolvedPeerInfo(host="127.0.0.1", port=uint16(11444)),
            UnresolvedPeerInfo(host="my.full-node.tld", port=uint16(111444)),
        },
    ),
    GetUnresolvedPeerInfosCase(
    ...
    GetUnresolvedPeerInfosCase(
        ...
        expected_peer_infos={
            UnresolvedPeerInfo(host="my.full-node.tld", port=uint16(111444)),
            UnresolvedPeerInfo(host="127.0.0.1", port=uint16(11444)),
            UnresolvedPeerInfo(host="my.other.full-node.tld", port=uint16(111444)),
        },
    ),
    GetUnresolvedPeerInfosCase(
