...
The workflows are located in [../.github/workflows/](https://github.com/Cactus-Network/cactus-blockchain/tree/main/.github/workflows).
...
Set `checkout_blocks_and_plots` to `False` to omit checking out the [test-cache](https://github.com/Cactus-Network/test-cache) repo.
