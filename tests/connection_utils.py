...
async def add_dummy_connection(
    ...
    cactus_ca_crt_path, cactus_ca_key_path = cactus_ssl_ca_paths(server.root_path, config)
    dummy_crt_path = server.root_path / "dummy.crt"
    dummy_key_path = server.root_path / "dummy.key"
    generate_ca_signed_cert(
        cactus_ca_crt_path.read_bytes(), cactus_ca_key_path.read_bytes(), dummy_crt_path, dummy_key_path
    )
