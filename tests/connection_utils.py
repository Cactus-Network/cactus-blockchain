...
async def disconnect_all_and_reconnect(server: CactusServer, reconnect_to: CactusServer) -> bool:
...
async def add_dummy_connection(server: CactusServer, dummy_port: int) -> Tuple[asyncio.Queue, bytes32]:
...
async def connect_and_get_peer(server_1: CactusServer, server_2: CactusServer) -> WSCactusConnection:
    """
