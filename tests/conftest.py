...
from cactus.simulator.setup_services import setup_daemon, setup_introducer, setup_timelord
...
async def empty_blockchain(request):
    ...
    """
    from cactus.simulator.setup_nodes import test_constants
...
@pytest_asyncio.fixture(scope="function")
async def two_wallet_nodes_custom_spam_filtering(spam_filter_after_n_txs, _spam_amount):
    async for _ in setup_simulators_and_wallets(1, 2, {}, spam_filter_after_n_txs, _spam_amount):
        yield _
