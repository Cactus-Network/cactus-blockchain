...
from cactus.simulator.setup_nodes import FullSystem, SimulatorsAndWallets
...
class TestSimulation:
    ...
    async def test_full_system(self, simulation, extra_node, self_hostname):
        ...
        server1: CactusServer = full_system.node_1._server
        ...
        await time_out_assert(60, verify_daemon_connection, True, full_system.daemon, "cactus_full_node")
