...
from cactus.protocols.shared_protocol import protocol_version, capabilities
...
class TestSSL:
    ...
    async def test_farmer(self, farmer_one_harvester, self_hostname):
        ...
        generate_ca_signed_cert(cactus_ca_crt_path.read_bytes(), cactus_ca_key_path.read_bytes(), pub_crt, pub_key)
        ssl_context = ssl_context_for_client(cactus_ca_crt_path, cactus_ca_key_path, pub_crt, pub_key)
    ...
    async def test_introducer(self, introducer_service, self_hostname):
        ...
        cactus_ca_crt_path, cactus_ca_key_path = cactus_ssl_ca_paths(introducer_service.root_path, introducer_service.config)
    ...
    async def test_timelord(self, timelord_service, self_hostname):
        ...
        cactus_ca_crt_path, cactus_ca_key_path = cactus_ssl_ca_paths(timelord_service.root_path, timelord_service.config)
