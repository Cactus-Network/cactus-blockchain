...
from cactus.plotting.util import stream_plot_info_ph, stream_plot_info_pk, PlotRefreshResult, PlotRefreshEvents
...
from cactus.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "cac"), encode_puzzle_hash(new_ph_2, "cac"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "cac"))
            ...
            assert config["farmer"]["cac_target_address"] == encode_puzzle_hash(new_ph, "cac")
            assert config["pool"]["cac_target_address"] == encode_puzzle_hash(new_ph_3, "cac")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "cac")
