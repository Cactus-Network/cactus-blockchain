...
@pytest.mark.asyncio
async def test_print_offer_summary_(capsys: Any) -> None:
...
@pytest.mark.asyncio
async def test_print_offer_summary__and_cats(capsys: Any) -> None:
    summary_dict = {
...
@pytest.mark.asyncio
async def test_print_offer_summary__and_cats_with_zero_values(capsys: Any) -> None:
    summary_dict = {
        "cac": 0,
...
@pytest.mark.asyncio
async def test_print_offer_summary__with_one_mojo(capsys: Any) -> None:
    summary_dict = {"cac": 1}
