...
from cactus.protocols.shared_protocol import Error, protocol_version
...
from cactus.server.ws_connection import WSCactusConnection, error_response_version
...
from cactus.util.ints import int16, uint32
...
async def test_connection_versions(
    ...
    for connection in [outgoing_connection, incoming_connection]:
        ...
        assert connection.version == cactus_full_version_str()
        assert connection.get_version() == cactus_full_version_str()
