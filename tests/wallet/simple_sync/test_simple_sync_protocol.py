...
from cactus.protocols import wallet_protocol, full_node_protocol
...
from cactus.protocols.wallet_protocol import RespondToCoinUpdates, CoinStateUpdate, RespondToPhUpdates, CoinState
