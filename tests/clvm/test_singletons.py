...
This test suite aims to test:
    - cactus.wallet.puzzles.singleton_top_layer.py
    - cactus.wallet.puzzles.singleton_top_layer.clsp
    - cactus.wallet.puzzles.singleton_top_layer_v1_1.py
    - cactus.wallet.puzzles.singleton_top_layer_v1_1.clsp
    - cactus.wallet.puzzles.p2_singleton.clsp
    - cactus.wallet.puzzles.p2_singleton_or_delayed_puzhash.clsp
"""
