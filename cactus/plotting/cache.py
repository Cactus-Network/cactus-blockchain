...
if TYPE_CHECKING:
    from cactus.plotting.prover import ProverProtocol

from chia_rs import G1Element, PrivateKey
from chia_rs.sized_bytes import bytes32
from chia_rs.sized_ints import uint16, uint64

from cactus.plotting.prover import get_prover_from_bytes
from cactus.plotting.util import parse_plot_info
from cactus.types.blockchain_format.proof_of_space import generate_plot_public_key
from cactus.util.streamable import Streamable, VersionedBlob, streamable
        ...
        try:
            ...
            if stored_cache.version == CURRENT_VERSION:
                ...
                for path, cache_entry in cache_data.entries:
                    ...
                    #       Related: - https://github.com/Cactus-Network/cactus-blockchain/issues/13084
                    #                - https://github.com/Cactus-Network/chiapos/pull/337
                    ...
                    if param.size_v1 is not None:
                        ...
                        # See https://github.com/Cactus-Network/chiapos/blob/3ee062b86315823dd775453ad320b8be892c7df3/src/prover_disk.hpp#L282-L287

                        # Use experimental measurements if more than estimates
                        # https://github.com/Cactus-Network/cactus-blockchain/issues/16063
