...
from cactus.plotters.plotters_util import get_venv_bin, reset_loop_policy_for_windows, run_command, run_plotter
...
def plot_bladebit(args, cactus_root_path, root_path):
    ...
    try:
        ...
        asyncio.run(run_plotter(cactus_root_path, args.plotter, call_args, progress))
    except Exception as e:
