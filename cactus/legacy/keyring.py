"""
Provides a helper to access the legacy keyring which was supported up to version 1.6.1 of cactus-blockchain. To use this
...
from cactus.cmds.cmds_util import prompt_yes_no
from cactus.util.errors import KeychainUserNotFound
from cactus.util.keychain import MAX_KEYS, KeyData, KeyDataSecrets, get_private_key_user
