...
from cactus.plotting.prover import PlotVersion, V1Prover, V2Prover, V2Quality
from cactus.plotting.util import PlotInfo, parse_plot_info
from cactus.protocols import harvester_protocol
from cactus.protocols.farmer_protocol import FarmingInfo
from cactus.protocols.harvester_protocol import PartialProofsData, Plot, PlotSyncResponse
...
class HarvesterAPI:
    ...
    async def _handle_v2_responses(
        self, v2_awaitables: Sequence[Awaitable[PartialProofsData | None]], start_time: float, peer: WSCactusConnection
    ) -> int:
