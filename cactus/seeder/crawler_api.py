...
class CrawlerAPI:
    ...
    @metadata.request(peer_required=True)
    async def new_peak(self, request: full_node_protocol.NewPeak, peer: WSCactusConnection) -> Message | None:
    ...
    async def new_compact_vdf(
        self, request: full_node_protocol.NewCompactVDF, peer: WSCactusConnection
    ) -> Message | None:
        pass
