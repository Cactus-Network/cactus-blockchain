...
from cactus.protocols.full_node_protocol import RespondPeers
...
class Crawler:
    ...
    async def create_client(
        self, peer_info: PeerInfo, on_connect: Callable[[WSCactusConnection], Awaitable[None]]
    ) -> bool:
    ...
    async def connect_task(self, peer: PeerRecord) -> None:
        ...
        async def peer_action(peer: WSCactusConnection) -> None:
            peer_info = peer.get_peer_info()
            version = cactus_short_version(peer.get_version())
