...
from cactus.protocols.wallet_protocol import CoinState, RespondBlockHeader, RespondToCoinUpdates
...
class WalletNode:
    ...
    async def new_peak_wallet(self, new_peak: wallet_protocol.NewPeakWallet, peer: WSCactusConnection) -> None:
        if self._wallet_state_manager is None:
