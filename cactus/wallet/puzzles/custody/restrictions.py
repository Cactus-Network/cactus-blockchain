...
FIXED_CREATE_COIN_DESTINATIONS = load_clvm_maybe_recompile(
    "fixed_create_coin_destinations.clsp", package_or_requirement="cactus.wallet.puzzles.custody"
)
SEND_MESSAGE_BANNED = load_clvm_maybe_recompile(
    "send_message_banned.clsp", package_or_requirement="cactus.wallet.puzzles.custody"
)
HEIGHTLOCK_WRAPPER = load_clvm_maybe_recompile("heightlock.clsp", package_or_requirement="cactus.wallet.puzzles.custody")
