...
address1 = "tcac15gx26ndmacfaqlq8m0yajeggzceu7cvmaz4df0hahkukes695rss6lej7h"  # Gene wallet (m/12381/11444/2/42):
address2 = "tcac1c2cguswhvmdyz9hr3q6hak2h6p9dw4rz82g4707k2xy2sarv705qcce4pn"  # Mariano address (m/12381/11444/2/0)
...
def make_puzzle(amount: int) -> int:
    ...
    if error:
        ...
        for cvp in result_human:
            ...
            total_cactus += int_from_bytes(cvp.vars[1])
            print(
...
total_cactus = 0
print("Pool address: ")
total_cactus += make_puzzle(pool_amounts)
print("\nFarmer address: ")
total_cactus += make_puzzle(farmer_amounts)

assert total_cactus == calculate_base_farmer_reward(uint32(0)) + calculate_pool_reward(uint32(0))
