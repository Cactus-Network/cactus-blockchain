...
from cactus.util.casts import int_from_bytes, int_to_bytes
...
from cactus.wallet.nft_wallet.nft_puzzle_utils import create_ownership_layer_puzzle, get_metadata_and_phs
from cactus.wallet.nft_wallet.nft_puzzles import NFT_METADATA_UPDATER
...
from cactus.wallet.singleton import SINGLETON_LAUNCHER_PUZZLE, SINGLETON_LAUNCHER_PUZZLE_HASH, create_singleton_puzzle
...
class NFTWallet:
    ...
    async def coin_added(
        self, coin: Coin, height: uint32, peer: WSCactusConnection, parent_coin_data: NFTCoinData | None
    ) -> None:
    ...
    async def mint_from_did(
        ...
        cac_coins: set[Coin] | None = None,
        cac_change_ph: bytes32 | None = None,
        ...
        await self.standard_wallet.create_tandem_cac_tx(
            ...
            action_scope,
            coins=cac_coins,
            extra_conditions=cac_extra_conditions,
            reserve_fee=fee,
            preferred_change_puzzle_hash=cac_change_ph,
        )
