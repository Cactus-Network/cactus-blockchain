...
class NFTWallet:
    ...
    async def generate_unsigned_spendbundle(
        ...
        if fee > 0:
            ...
            cactus_tx = await self.create_tandem_cac_tx(
    ...
    async def mint_from_did(
        ...
        for mint_number in range(mint_number_start, mint_number_end):
            ...
            intermediate_launcher_puz = did_wallet_puzzles.INTERMEDIATE_LAUNCHER_MOD.curry(
                cactus.wallet.singleton.LAUNCHER_PUZZLE_HASH, mint_number, mint_total
            )
            ...
            launcher_coin = Coin(intermediate_launcher_coin.name(), cactus.wallet.singleton.LAUNCHER_PUZZLE_HASH, amount)
            ...
            launcher_cs = CoinSpend(launcher_coin, cactus.wallet.singleton.LAUNCHER_PUZZLE, genesis_launcher_solution)
        ...
        did_full_puzzle: Program = cactus.wallet.singleton.create_fullpuz(
            innerpuz,
