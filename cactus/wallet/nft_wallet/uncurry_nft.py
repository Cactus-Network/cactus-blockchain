...
from cactus.wallet.nft_wallet.nft_puzzles import NFT_OWNERSHIP_LAYER
from cactus.wallet.nft_wallet.nft_puzzles import NFT_STATE_LAYER_MOD as NFT_MOD
from cactus.wallet.singleton import SINGLETON_TOP_LAYER_MOD
...
class UncurriedNFT(Streamable):
    ...
    This is the only place you need to change after modified the Cactuslisp curried parameters.
    """
