...
from cactus_rs import compute_merkle_set_root, confirm_included_already_hashed, confirm_not_included_already_hashed
...
async def fetch_coin_spend(height: uint32, coin: Coin, peer: WSCactusConnection) -> CoinSpend:
...
async def fetch_coin_spend_for_coin_state(coin_state: CoinState, peer: WSCactusConnection) -> CoinSpend:
