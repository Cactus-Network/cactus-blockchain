...
from cactus.wallet.did_wallet.did_wallet_puzzles import match_did_puzzle, uncurry_innerpuz
...
from cactus.wallet.util.curry_and_treehash import NIL_TREEHASH, shatree_int, shatree_pair
...
class DIDWallet:
    ...
    async def coin_added(self, coin: Coin, _: uint32, peer: WSCactusConnection, parent_coin_data: Optional[DIDCoinData]):
