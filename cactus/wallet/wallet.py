...
from cactus.wallet.conditions import AssertCoinAnnouncement, Condition, CreateCoinAnnouncement, parse_timelock_info
...
from cactus.wallet.puzzles.puzzle_utils import make_create_coin_condition, make_reserve_fee_condition
...
class Wallet:
    ...
    async def sign_message(self, message: str, puzzle_hash: bytes32, mode: SigningMode) -> Tuple[G1Element, G2Element]:
        ...
        # https://github.com/Cactus-Network/chips/blob/80e4611fe52b174bf1a0382b9dff73805b18b8c6/CHIPs/chip-0002.md#signmessage
    ...
    async def create_tandem_cac_tx(
        ...
        cactus_coins = await self.select_coins(fee, action_scope)
    ...
    # WSCactusConnection is only imported for type checking
