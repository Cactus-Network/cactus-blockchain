...
from cactus.types.coin_spend import compute_additions_with_cost
...
from cactus.wallet.cat_wallet.cat_info import CATCoinData, CATInfo, LegacyCATInfo
...
class CATWallet:
    ...
    async def create_new_cat_wallet(
        ...
        cactus_tx = dataclasses.replace(cactus_tx, spend_bundle=spend_bundle, name=spend_bundle.name())
    ...
    async def coin_added(
        self, coin: Coin, height: uint32, peer: WSCactusConnection, parent_coin_data: Optional[CATCoinData]
    ) -> None:
