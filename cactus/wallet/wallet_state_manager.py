...
class WalletStateManager:
    ...
    async def filter_spam(self, new_coin_state: List[CoinState]) -> List[CoinState]:
        _spam_amount = self.config.get("_spam_amount", 1000000)
        ...
        small_unspent_count = await self.coin_store.count_small_unspent(_spam_amount)
        ...
        for cs in new_coin_state:
            ...
            if (
                ...
                and cs.coin.amount < _spam_amount
