...
from cactus.data_layer.data_layer_wallet import DataLayerWallet
from cactus.data_layer.dl_wallet_store import DataLayerStore
from cactus.data_layer.singleton_record import SingletonRecord
from cactus.pools import pool_config
...
from cactus.util.db_wrapper import DBWrapper2, PurposefulAbort
...
from cactus.util.streamable import Streamable, UInt32Range, UInt64Range, VersionedBlob
from cactus.wallet.cat_wallet.cat_constants import DEFAULT_CATS
from cactus.wallet.cat_wallet.cat_info import CATCoinData, CATInfo, CRCATInfo
from cactus.wallet.cat_wallet.cat_utils import CAT_MOD, CAT_MOD_HASH, construct_cat_puzzle, match_cat_puzzle
...
from cactus.wallet.db_wallet.db_wallet_puzzles import MIRROR_PUZZLE_HASH
...
from cactus.wallet.did_wallet.did_info import DIDCoinData, DIDInfo, did_recovery_is_nil
from cactus.wallet.did_wallet.did_wallet import DIDWallet
from cactus.wallet.did_wallet.did_wallet_puzzles import (
    DID_INNERPUZ_MOD,
...
from cactus.wallet.nft_wallet import nft_puzzle_utils
from cactus.wallet.nft_wallet.nft_info import NFTCoinInfo, NFTInfo
from cactus.wallet.nft_wallet.nft_puzzle_utils import get_metadata_and_phs, get_new_owner_did
...
from cactus.wallet.notification_manager import NotificationManager
from cactus.wallet.outer_puzzles import AssetType
from cactus.wallet.puzzle_drivers import PuzzleInfo
from cactus.wallet.puzzles.clawback.drivers import generate_clawback_spend_bundle, match_clawback_puzzle
from cactus.wallet.puzzles.clawback.metadata import ClawbackMetadata, ClawbackVersion
from cactus.wallet.remote_wallet.remote_coin_store import RemoteCoinStore
from cactus.wallet.remote_wallet.remote_wallet import RemoteWallet
from cactus.wallet.signer_protocol import (
    KeyHints,
    PathHint,
    SignedTransaction,
    SigningInstructions,
...
from cactus.wallet.singleton import SINGLETON_LAUNCHER_PUZZLE_HASH as SINGLETON_LAUNCHER_HASH
from cactus.wallet.singleton import create_singleton_puzzle, get_inner_puzzle_from_singleton
...
from cactus.wallet.transaction_record import LightTransactionRecord, TransactionRecord
from cactus.wallet.uncurried_puzzle import uncurry_puzzle
from cactus.wallet.util.address_type import AddressType
from cactus.wallet.util.compute_additions import compute_additions
...
from cactus.wallet.util.curry_and_treehash import NIL_TREEHASH
from cactus.wallet.util.puzzle_decorator import PuzzleDecoratorManager
from cactus.wallet.util.query_filter import FilterMode, HashFilter
from cactus.wallet.util.transaction_type import CLAWBACK_INCOMING_TRANSACTION_TYPES, TransactionType
from cactus.wallet.util.tx_config import TXConfig, TXConfigLoader
from cactus.wallet.util.wallet_sync_utils import (
    PeerRequestException,
    fetch_coin_spend_for_coin_state,
    last_change_height_cs,
)
from cactus.wallet.util.wallet_types import CoinType, WalletIdentifier, WalletType
from cactus.wallet.vc_wallet.cr_cat_drivers import CRCAT, ProofsChecker, construct_pending_approval_state
from cactus.wallet.vc_wallet.cr_cat_wallet import CRCATWallet
from cactus.wallet.vc_wallet.vc_drivers import VerifiedCredential, match_revocation_layer
from cactus.wallet.vc_wallet.vc_store import VCStore
from cactus.wallet.vc_wallet.vc_wallet import VCWallet
from cactus.wallet.wallet import Wallet
from cactus.wallet.wallet_action_scope import WalletActionScope, new_wallet_action_scope
from cactus.wallet.wallet_blockchain import WalletBlockchain
from cactus.wallet.wallet_coin_record import MetadataTypes, WalletCoinRecord
from cactus.wallet.wallet_coin_store import CoinRecordOrder, WalletCoinStore
...
from cactus.wallet.wallet_retry_store import WalletRetryStore
...
from cactus.wallet.wsm_apis import CreateMorePuzzleHashesResult, GetUnusedDerivationRecordResult
...
class WalletStateManager:
    ...
    async def determine_coin_type(
        self, peer: WSCactusConnection, coin_state: CoinState, fork_height: uint32 | None
    ...
    async def get_minter_did(self, launcher_coin: Coin, peer: WSCactusConnection) -> bytes32 | None:
        # Get minter DID
    ...
    def encode_puzzle_hash(self, puzzle_hash: bytes32) -> str:
        return encode_puzzle_hash(puzzle_hash, AddressType.CAC.hrp(self.config))
    ...
    async def get_latest_singleton_coin_spend(
        self, peer: WSCactusConnection, coin_id: bytes32, latest: bool = True
