...
from cactus.wallet.did_wallet.did_info import DIDCoinData
from cactus.wallet.did_wallet.did_wallet import DIDWallet
from cactus.wallet.did_wallet.did_wallet_puzzles import DID_INNERPUZ_MOD, match_did_puzzle
...
from cactus.wallet.singleton import create_singleton_puzzle, get_inner_puzzle_from_singleton, get_singleton_id_from_puzzle
...
from cactus.wallet.vc_wallet.vc_drivers import VerifiedCredential
...
class WalletStateManager:
    ...
    async def get_minter_did(self, launcher_coin: Coin, peer: WSCactusConnection) -> Optional[bytes32]:
        # Get minter DID
