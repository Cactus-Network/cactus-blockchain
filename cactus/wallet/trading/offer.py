...
from cactus.util.streamable import Streamable, parse_rust, streamable
...
class Offer:
    ...
    def notarize_payments(
        requested_payments: dict[bytes32 | None, list[CreateCoin]],  # `None` means you are requesting CAC
        coins: list[Coin],
