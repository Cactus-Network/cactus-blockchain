...
def show_cmd(
    ...
    if connections:
        print("'cactus show -c' has been renamed to 'cactus peer -c' ")
    if add_connection != "":
        print("'cactus show -a' has been renamed to 'cactus peer -a' ")
    if remove_connection != "":
        print("'cactus show -r' has been renamed to 'cactus peer -r' ")
