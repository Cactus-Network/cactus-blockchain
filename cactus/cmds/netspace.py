...
def netspace_cmd(ctx: click.Context, rpc_port: int | None, delta_block_height: str, start: str) -> None:
    ...
    from cactus.cmds.netspace_funcs import netstorge_async

    asyncio.run(netstorge_async(CactusCliContext.set_default(ctx).root_path, rpc_port, delta_block_height, start))
