...
def generate(shell: str) -> None:
    ...
    You can source it directly (performs slower) by running:
        \033[3;33meval "$(cactus complete generate)"\033[0m
    or you can save the output to a file:
        \033[3;33mcactus complete generate > ~/.cactus-complete-bash\033[0m
    and source that file with:
        \033[3;33m. ~/.cactus-complete-bash\033[0m
    """
    ...
    subprocess.run(["cactus"], check=True, env={**os.environ, "_CACTUS_COMPLETE": f"{shell}_source"})
