...
from cactus.cmds.cmds_util import NODE_TYPES
from cactus.cmds.peer_funcs import peer_async
...
@click.option("-a", "--add-connection", help="Connect specified Cactus service to ip:port", type=str, default="")
@click.option(
