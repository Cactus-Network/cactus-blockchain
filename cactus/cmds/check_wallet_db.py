...
help_text = """
\b
    The purpose of this command is find potential issues in Cactus wallet databases.
    The core cactus client currently uses sqlite to store the wallet databases, one database per key.
\b
