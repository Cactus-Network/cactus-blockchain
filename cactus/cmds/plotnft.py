...
class ShowPlotNFTCMD:
    ...
    async def run(self) -> None:
        from cactus.cmds.plotnft_funcs import show
...
class GetLoginLinkCMD:
    ...
    async def run(self) -> None:
        from cactus.cmds.plotnft_funcs import get_login_link
...
class LeavePlotNFTCMD:
    ...
    async def run(self) -> None:
        from cactus.cmds.plotnft_funcs import self_pool
...
class InspectPlotNFTCMD:
    ...
    async def run(self) -> None:
        from cactus.cmds.plotnft_funcs import inspect_cmd
...
class ClaimPlotNFTCMD:
    ...
    async def run(self) -> None:
        from cactus.cmds.plotnft_funcs import claim_cmd
...
class ChangePayoutInstructionsPlotNFTCMD:
    ...
    async def run(self) -> None:
        from cactus.cmds.plotnft_funcs import change_payout_instructions
