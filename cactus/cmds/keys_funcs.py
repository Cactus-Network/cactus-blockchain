...
from cactus.util.keychain import Keychain, bytes_to_mnemonic, generate_mnemonic
...
def show_all_keys(show_mnemonic: bool):
    ...
    for sk, seed in private_keys:
        ...
        print(
            "Farmer public key (m/12381/11444/0/0):",
        ...
        if show_mnemonic:
            ...
            print(
                "First wallet secret key (m/12381/11444/2/0):",
