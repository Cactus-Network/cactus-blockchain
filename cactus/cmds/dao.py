...
from cactus.cmds.cmds_util import CMDTXConfigLoader, tx_config_args, tx_out_cmd
from cactus.cmds.param_types import AmountParamType, Bytes32ParamType, CliAmount, TransactionFeeParamType, Uint64ParamType
...
def dao_create_cmd(
    ...
    return asyncio.run(
        create_dao_wallet(
            ...
            self_destruct,
            oracle_delay,
            proposal_minimum.convert_amount(units["cactus"]),
            filter_amount,
            cat_amount,
            CMDTXConfigLoader(
