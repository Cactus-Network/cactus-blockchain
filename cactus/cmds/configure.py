    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if testnet:
            if testnet in {"true", "t"}:
                ...
                testnet_port = "511444"
                testnet_introducer = "introducer-testnet11.cactus-network.net"
                testnet_dns_introducer = "dns-introducer-testnet11.cactus-network.net"
                bootstrap_peers = ["testnet11-node-us-west-2.cactus-network.net"]
                testnet = "testnet11"
