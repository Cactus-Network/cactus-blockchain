...
from cactus.data_layer.data_layer_errors import ProofIntegrityError
...
from cactus.wallet.db_wallet.db_wallet_puzzles import create_host_fullpuz
...
@dataclasses.dataclass(frozen=True)
class Layer:
    # This class is similar to cactus.data_layer.data_layer_util.ProofOfInclusionLayer
