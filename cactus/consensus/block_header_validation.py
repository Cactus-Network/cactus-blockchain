...
from cactus.consensus.get_block_challenge import (
...
def validate_unfinished_header_block(
    ...
    # checks need to be valid regardless of order and the numbers are reflecting the numbers as written in the cactus docs
