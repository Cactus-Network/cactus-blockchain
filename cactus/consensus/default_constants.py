...
DEFAULT_CONSTANTS = ConsensusConstants(
    ...
    GENESIS_CHALLENGE=bytes32.fromhex("d3cb42f2029fda7927fc177c49789544044656f2437e6130ab9471f17770124f"),
    # Forks of cactus should change the AGG_SIG_*_ADDITIONAL_DATA values to provide
