...
from cactus.data_layer.data_layer_util import DLProof, VerifyProofResponse
from cactus.data_layer.data_layer_wallet import Mirror, SingletonRecord
...
from cactus.wallet.conditions import Condition, ConditionValidTimes, conditions_to_json_dicts
...
from cactus.wallet.vc_wallet.vc_store import VCRecord
...
class WalletRpcClient(RpcClient):
    ...
    async def nft_mint_bulk(
        ...
        cac_coins: Optional[List[Dict[str, Any]]] = None,
        cac_change_target: Optional[str] = None,
        ...
        request = {
            ...
            "cac_coins": cac_coins,
            "cac_change_target": cac_change_target,
