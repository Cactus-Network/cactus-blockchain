...
from cactus.data_layer.data_layer_errors import LauncherCoinNotFoundError
from cactus.data_layer.data_layer_util import dl_verify_proof
...
from cactus.rpc.rpc_server import Endpoint, EndpointResult, default_get_connections
from cactus.rpc.util import marshal, tx_endpoint
...
from cactus.util.config import load_config, str2bool
...
from cactus.util.streamable import Streamable, UInt32Range, streamable
...
from cactus.wallet.cat_wallet.cat_info import CRCATInfo
from cactus.wallet.cat_wallet.cat_wallet import CATWallet
from cactus.wallet.cat_wallet.dao_cat_info import LockedCoinInfo
...
from cactus.wallet.did_wallet.did_info import DIDCoinData, DIDInfo
...
from cactus.wallet.notification_store import Notification
...
from cactus.wallet.puzzles import p2_delegated_conditions
from cactus.wallet.puzzles.clawback.metadata import AutoClaimSettings, ClawbackMetadata
from cactus.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import puzzle_hash_for_synthetic_public_key
from cactus.wallet.signer_protocol import SigningResponse
from cactus.wallet.singleton import (
...
from cactus.wallet.util.address_type import AddressType, is_valid_address
...
from cactus.wallet.util.query_filter import FilterMode, HashFilter, TransactionTypeFilter
from cactus.wallet.util.transaction_type import CLAWBACK_INCOMING_TRANSACTION_TYPES, TransactionType
from cactus.wallet.util.tx_config import DEFAULT_TX_CONFIG, TXConfig, TXConfigLoader
from cactus.wallet.util.wallet_sync_utils import fetch_coin_spend_for_coin_state
from cactus.wallet.util.wallet_types import CoinType, WalletType
from cactus.wallet.vc_wallet.cr_cat_drivers import ProofsChecker
from cactus.wallet.vc_wallet.cr_cat_wallet import CRCATWallet
from cactus.wallet.vc_wallet.vc_store import VCProofs
...
from cactus.wallet.wallet_coin_store import CoinRecordOrder, GetCoinRecords, unspent_range
...
class WalletRpcApi:
            ...
            if request["mode"] == "new":
                if request.get("test", False):
                    ...
                    raise ValueError(
                        ...
                        " Please use the CAT Admin Tool @ https://github.com/Cactus-Network/CAT-admin-tool instead."
                    )
    ...
    async def verify_signature(self, request: Dict[str, Any]) -> EndpointResult:
        ...
        # signatures made by `cactus keys sign`, which uses BLS_MESSAGE_AUGMENTATION_HEX_INPUT
    ...
    async def get_offer_summary(self, request: Dict[str, Any]) -> EndpointResult:
        ...
        from cactus.wallet.util.puzzle_compression import OFFER_MOD_OLD, decompress_object_with_puzzles
