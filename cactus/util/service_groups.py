...
SERVICES_FOR_GROUP = {
    "all": (
        "cactus_harvester cactus_timelord_launcher cactus_timelord cactus_farmer "
        "cactus_full_node cactus_wallet cactus_data_layer cactus_data_layer_http"
    ).split(),
    # TODO: should this be `data_layer`?
    "data": "cactus_wallet cactus_data_layer".split(),
    "data_layer_http": "cactus_data_layer_http".split(),
    ...
    "wallet": "cactus_wallet".split(),
    "introducer": "cactus_introducer".split(),
    "simulator": "cactus_full_node_simulator".split(),
    "crawler": "cactus_crawler".split(),
    "seeder": "cactus_crawler cactus_seeder".split(),
    "seeder-only": "cactus_seeder".split(),
}
