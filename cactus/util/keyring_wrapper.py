...
# the new passphrase.
DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE = "$ cactus passphrase set # all the cool kids are doing it!"  # noqa: S105

MASTER_PASSPHRASE_SERVICE_NAME = "Cactus Passphrase"  # noqa: S105
MASTER_PASSPHRASE_USER_NAME = "Cactus Passphrase"  # noqa: S105
