...
class SigningMode(Enum):
    ...
    # CHIP-0002 signs the result of sha256tree(cons("Cactus Signed Message", message)) using the
    ...
    # Standard BLS signatures used by Cactus use the BLS message augmentation scheme
