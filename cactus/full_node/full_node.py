...
from cactus.full_node.subscriptions import PeerSubscriptions
...
from cactus.util.profiler import mem_profile_task, profile_task
...
class FullNode:
    ...
    def set_server(self, server: CactusServer) -> None:
        ...
        if "dns_servers" in self.config:
            ...
            dns_servers.append("dns-introducer.cactus-network.network.net")
        try:
    ...
    def on_disconnect(self, connection: WSCactusConnection) -> None:
