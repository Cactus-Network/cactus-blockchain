...
from cactus.consensus.block_rewards import calculate_pool_reward
from cactus.consensus.coinbase import pool_parent_id
from cactus.pools.pool_wallet_info import LEAVING_POOL, SELF_POOLING, PoolState
...
from cactus.wallet.puzzles.singleton_top_layer import puzzle_for_singleton
from cactus.wallet.util.curry_and_treehash import calculate_hash_of_quoted_mod_hash, curry_and_treehash, shatree_atom
...
POOL_WAITING_ROOM_MOD = load_clvm_maybe_recompile(
    "pool_waitingroom_innerpuz.clsp", package_or_requirement="cactus.pools.puzzles"
)
POOL_MEMBER_MOD = load_clvm_maybe_recompile("pool_member_innerpuz.clsp", package_or_requirement="cactus.pools.puzzles")
...
def solution_to_pool_state(full_spend: CoinSpend) -> Optional[PoolState]:
    ...
    if num_args == 2:
        ...
        # This is referred to as p1 in the cactuslisp code
