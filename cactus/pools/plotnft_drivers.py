...
from cactus.wallet.puzzles.custody.custody_architecture import (
    DelegatedPuzzleAndSolution,
    MofN,
    ProvenSpend,
    PuzzleWithRestrictions,
)
from cactus.wallet.puzzles.custody.member_puzzles import BLSWithTaprootMember, FixedPuzzleMember, SingletonMember
from cactus.wallet.puzzles.custody.restriction_utilities import ValidatorStackRestriction
from cactus.wallet.puzzles.custody.restrictions import FixedCreateCoinDestinations, Heightlock, SendMessageBanned
...
CLAIM_POOL_REWARDS_DELEGATED_PUZZLE = load_clvm_maybe_recompile(
    "claim_pool_rewards_dpuz.clsp", package_or_requirement="cactus.pools"
)
FORWARD_TO_POOL_PUZZLE_HASH_DELEGATED_PUZZLE = load_clvm_maybe_recompile(
    "forward_to_pool_puzzle_hash_dpuz.clsp", package_or_requirement="cactus.pools"
)
