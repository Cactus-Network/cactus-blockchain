...
from cactus.pools.pool_wallet_info import NewPoolWalletInitialTargetState, PoolSingletonState, PoolWalletInfo
...
from cactus.wallet.wallet_state_manager import SyncStatus, WalletStateManager
            ...
            tr: TransactionRecord = (
                await client.send_transaction(
                    SendTransaction(
                        wallet_id=uint32(1),
                        amount=uint64(100),
                        address=encode_puzzle_hash(status.p2_singleton_puzzle_hash, "tcac"),
                        push=True,
                    ),
                    DEFAULT_TX_CONFIG,
                )
