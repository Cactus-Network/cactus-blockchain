...
def test_cactus_installed() -> None:
    """This checks that the in-memory cactus package was loaded from an installed copy
    ...
    """
    assert ".venv" in pathlib.Path(cactus.__file__).parts
