...
from cactus._tests.environments.full_node import FullNodeEnvironment
from cactus._tests.environments.wallet import WalletEnvironment
...
OldSimulatorsAndWallets = tuple[list[FullNodeSimulator], list[tuple[WalletNode, CactusServer]], BlockTools]
...
) -> AsyncIterator[tuple[FullNodeAPI, FullNodeAPI, CactusServer, CactusServer, BlockTools]]:
    """
