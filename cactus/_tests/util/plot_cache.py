...
from cactus.plotting.prover import QualityProtocol, V1Prover, V1Quality, V2Prover, V2Quality
...
def install(plot_dir: Path) -> None:
    ...
    setattr(__import__("cactus.simulator.block_tools", fromlist=["solve_proof"]), "solve_proof", cached_solve_proof)
    setattr(__import__("cactus.solver.solver", fromlist=["solve_proof"]), "solve_proof", cached_solve_proof)
