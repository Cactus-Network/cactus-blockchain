...
def test_cactus_short_version_from_version(version: Version, result: str) -> None:
    assert cactus_short_version(version) == result


def test_cactus_short_version() -> None:
    assert cactus_short_version() == cactus_short_version(Version(__version__))
...
def test_cactus_short_version_from_str(version: str, result: Optional[str]) -> None:
    assert cactus_short_version(version) == result
