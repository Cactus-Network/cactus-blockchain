"""
Tests for cactus.rpc.rpc_errors: RpcError and structured_error_from_exception.
"""

from __future__ import annotations

from cactus.rpc.rpc_errors import RpcError, RpcErrorCodes, structured_error_from_exception
from cactus.util.errors import ApiError as UtilApiError
from cactus.util.errors import ConsensusError, Err, ProtocolError, TimestampError, ValidationError
