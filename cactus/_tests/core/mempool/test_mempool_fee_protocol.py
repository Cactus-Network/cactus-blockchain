...
from cactus.protocols.wallet_protocol import RespondFeeEstimates
...
async def test_protocol_messages(
    simulator_and_wallet: tuple[list[FullNodeAPI | FullNodeSimulator], list[tuple[Wallet, CactusServer]], BlockTools],
) -> None:
