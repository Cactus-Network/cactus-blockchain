...
from cactus._tests.core.node_height import node_height_between, node_height_exactly
...
async def test_short_sync_batch_returns_false_on_disconnected_first_block(
    ...
    peer = cast(WSCactusConnection, _FakePeer())
...
@pytest.mark.anyio
@pytest.mark.skip("skipping until we re-enable the capability in cactus.protocols.shared_protocol")
