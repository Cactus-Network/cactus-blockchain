...
async def test_sync_target_peak_gather_skips_deserialize_failure(
    ...
    bad_peer.get_peer_logging = MagicMock(return_value=PeerInfo("10.0.0.1", 11444))
    ...
    good_peer.get_peer_logging = MagicMock(return_value=PeerInfo("10.0.0.2", 11444))
    ...
    monkeypatch.setattr(
        "cactus.full_node.full_node.check_fork_next_block",
...
async def test_sync_target_peak_gather_does_not_ban_on_timeout(
    ...
    slow_peer.get_peer_logging = MagicMock(return_value=PeerInfo("10.0.0.3", 11444))
