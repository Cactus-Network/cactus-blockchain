...
from cactus._tests.core.data_layer.util import Example, add_0123_example, add_01234567_example
from cactus._tests.util.misc import BenchmarkRunner, Marks, boolean_datacases, datacases
from cactus.data_layer.data_layer_errors import KeyNotFoundError, TreeGenerationIncrementingError
...
from cactus.data_layer.download_data import insert_from_delta_file, write_files_for_root
from cactus.data_layer.util.benchmark import generate_datastore
...
async def test_server_http_ban(
    ...
    with monkeypatch.context() as m:
        ...
        m.setattr("cactus.data_layer.download_data.http_download", mock_http_download)
...
async def test_insert_from_delta_file(
    ...
    sinfo = ServerInfo("http://127.0.0.1/8003", 0, 0)
    with monkeypatch.context() as m:
        m.setattr("cactus.data_layer.download_data.http_download", mock_http_download_2)
        success = await insert_from_delta_file(
            data_store=data_store,
            store_id=store_id,
            existing_generation=0,
