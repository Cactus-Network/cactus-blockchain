...
from cactus._tests.util.generator_tools_testing import run_and_get_removals_and_additions
...
class TestBlockchainTransactions:
    ...
    async def test_basic_blockchain_tx(
        self, two_nodes: tuple[FullNodeAPI, FullNodeAPI, CactusServer, CactusServer, BlockTools], self_hostname: str
    ) -> None:
        num_blocks = 10
        wallet_a = WALLET_A
