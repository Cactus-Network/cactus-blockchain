...
from cactus.consensus.augmented_chain import AugmentedBlockchain, AugmentedBlockchainValidationError
from cactus.consensus.blockchain_interface import MMRManagerProtocol
from cactus.consensus.stub_mmr_manager import StubMMRManager
...
class NullBlockchain:
    if TYPE_CHECKING:
        from cactus.consensus.blockchain_interface import BlocksProtocol
