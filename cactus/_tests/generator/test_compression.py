...
import pytest
from cactus_rs import ALLOW_BACKREFS
from clvm.serialize import sexp_from_stream
from clvm.SExp import SExp
from clvm_tools import binutils

from cactus._tests.core.make_block_generator import make_spend_bundle
from cactus._tests.generator.test_rom import run_generator
...
TEST_GEN_DESERIALIZE = load_clvm(
    "test_generator_deserialize.clsp", package_or_requirement="cactus._tests.generator.puzzles"
)
DESERIALIZE_MOD = load_clvm("cactuslisp_deserialisation.clsp", package_or_requirement="cactus.consensus.puzzles")

DECOMPRESS_PUZZLE = load_clvm("decompress_puzzle.clsp", package_or_requirement="cactus.full_node.puzzles")
DECOMPRESS_CSE = load_clvm("decompress_coin_spend_entry.clsp", package_or_requirement="cactus.full_node.puzzles")

DECOMPRESS_CSE_WITH_PREFIX = load_clvm(
    "decompress_coin_spend_entry_with_prefix.clsp", package_or_requirement="cactus.full_node.puzzles"
)
DECOMPRESS_BLOCK = load_clvm("block_program_zero.clsp", package_or_requirement="cactus.full_node.puzzles")
TEST_MULTIPLE = load_clvm(
    "test_multiple_generator_input_arguments.clsp", package_or_requirement="cactus._tests.generator.puzzles"
)
