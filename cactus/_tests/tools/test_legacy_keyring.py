...
from cactus.legacy.keyring import create_legacy_keyring, generate_and_add, get_keys, legacy_keyring
...
def test_legacy_keyring_format(tmp_dir: Path) -> None:
    ...
    keyring_data = """
    [cactus_2Duser_2Dcactus_2D1_2E8]
    wallet_2duser_2dcactus_2d1_2e8_2d0 =
    ...
    wallet_2duser_2dcactus_2d1_2e8_2d1 =
