...
from cactus.cmds.cmd_helpers import NeedsTXConfig, NeedsWalletRPC, TransactionEndpoint, TransactionsOut, WalletClientInfo
from cactus.cmds.param_types import CliAmount, cli_amount_none
...
from cactus.wallet.transaction_record import LightTransactionRecord
from cactus.wallet.util.transaction_type import CLAWBACK_INCOMING_TRANSACTION_TYPES
from cactus.wallet.util.tx_config import DEFAULT_TX_CONFIG, TXConfig
from cactus.wallet.wallet import Wallet
from cactus.wallet.wallet_node import Balance, WalletNode
from cactus.wallet.wallet_node_api import WalletNodeAPI
from cactus.wallet.wallet_request_types import GetWalletBalance
...
class WalletTestFramework:
    ...
    def new_puzzle_hashes_allowed() -> Iterator[None]:
        with unittest.mock.patch(
            "cactus.wallet.wallet_state_manager.WalletStateManager.new_action_scope",
