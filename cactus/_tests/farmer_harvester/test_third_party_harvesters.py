...
from cactus._tests.util.misc import patch_request_handler
...
from cactus.farmer.farmer import Farmer, calculate_harvester_fee_quality
...
from cactus.protocols import farmer_protocol, full_node_protocol, harvester_protocol, timelord_protocol
from cactus.protocols.harvester_protocol import ProofOfSpaceFeeInfo, RespondSignatures, SigningDataKind
...
async def test_harvester_receive_source_signing_data(
    ...
    See: CHIP-22: https://github.com/Cactus-Network/chips/pull/88
    """
    (
        farmer_service,
        harvester_service,
    ...
    async def intercept_farmer_new_proof_of_space(
        self: HarvesterAPI, request: harvester_protocol.NewProofOfSpace, peer: WSCactusConnection
    ) -> None:
        nonlocal farmer
        nonlocal farmer_reward_address
...
async def test_harvester_fee_convention(
    ...
    """
    Tests fee convention specified in CHIP-22: https://github.com/Cactus-Network/chips/pull/88
    """
    (
        farmer_service,
        _,
...
async def test_harvester_fee_invalid_convention(
    ...
    given the fee convention from CHIP-22: https://github.com/Cactus-Network/chips/pull/88
    """
    (
        farmer_service,
        _,
...
def node_type_connected(server: CactusServer, node_type: NodeType) -> bool:
