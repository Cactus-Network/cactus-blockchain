...
from cactus.protocols.farmer_protocol import RequestSignedValues
...
from cactus.types.aliases import FarmerService, FullNodeService, HarvesterService
...
async def test_harvester_receive_source_signing_data(
    ...
    async def intercept_farmer_new_proof_of_space(*args: Any) -> None:
        ...
        peer: WSCactusConnection = args[1]
...
async def wait_until_node_type_connected(server: CactusServer, node_type: NodeType) -> WSCactusConnection:
    while True:
