...
from cactus.wallet.did_wallet.did_info import did_recovery_is_nil
...
def test_did_create(capsys: object, get_test_cli_clients: tuple[TestRpcClients, Path]) -> None:
    ...
    assert_list = [
        ...
        (
            "Successfully created a DID did:cactus:1qgpqyqszqgpqyqszqgpqyqszqgpqyqszqgpqyqszqgpqyqszqgpq4msw0c"
    ...
    class DidGetDidRpcClient(TestWalletRpcClient):
        async def get_did_id(self, request: DIDGetDID) -> DIDGetDIDResponse:
            ...
            return DIDGetDIDResponse(
                ...
                my_did=encode_puzzle_hash(get_bytes32(1), "did:cactus:"),
