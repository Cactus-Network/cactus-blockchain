...
from cactus._tests.cmds.wallet.test_consts import FINGERPRINT, FINGERPRINT_ARG, get_bytes32
from cactus.rpc.wallet_request_types import GetNotifications, GetNotificationsResponse
