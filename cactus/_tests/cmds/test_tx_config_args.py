...
from cactus.cmds.cmds_util import CMDCoinSelectionConfigLoader, CMDTXConfigLoader, coin_selection_args, tx_config_args
from cactus.cmds.param_types import CliAmount
from cactus.types.blockchain_format.sized_bytes import bytes32
from cactus.util.config import create_default_cactus_config, load_config
...
def test_tx_config_args() -> None:
    ...
    with runner.isolated_filesystem():
        create_default_cactus_config(Path("."))
