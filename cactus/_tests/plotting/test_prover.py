...
from cactus.plotting.prover import PlotVersion, V1Prover, V2Prover, get_prover_from_bytes, get_prover_from_file
...
class TestGetProverFromBytes:
    def test_get_prover_from_bytes_v1_plot(self) -> None:
        with patch("cactus.plotting.prover.DiskProver") as mock_disk_prover_class:
            mock_disk_prover = MagicMock()
