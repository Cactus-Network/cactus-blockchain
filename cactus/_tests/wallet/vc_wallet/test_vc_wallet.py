...
from cactus._tests.environments.wallet import WalletEnvironment, WalletStateTransition, WalletTestFramework
...
from cactus.wallet.vc_wallet.cr_cat_drivers import ProofsChecker, construct_cr_layer
    ...
    vc_record = (
        await client_0.vc_mint(
            VCMint(
                ...
                target_address=encode_puzzle_hash(ph, "tcac"),
