...
from cactus.consensus.condition_tools import conditions_dict_for_solution
...
async def test_create_new_did_wallet_failures_no_orphan(wallet_environments: WalletTestFramework):
    """
    Regression test for https://github.com/Cactus-Network/cactus-blockchain/pull/20575
...
async def test_creation_from_backup_file(wallet_environments: WalletTestFramework) -> None:
    ...
    async with env_1.wallet_state_manager.new_action_scope(wallet_environments.tx_config, push=True) as action_scope:
        did_wallet_1: DIDWallet = await DIDWallet.create_new_did_wallet(
            env_1.wallet_state_manager, env_1.cac_wallet, uint64(201), action_scope
        )
