...
from cactus._tests.cmds.wallet.test_consts import STD_TX
...
from cactus.cmds.cmd_classes import cactus_command
from cactus.cmds.cmd_helpers import NeedsWalletRPC, TransactionsIn, TransactionsOut, WalletClientInfo
from cactus.cmds.cmds_util import TransactionBundle
from cactus.cmds.signer import (
    ApplySignaturesCMD,
...
from cactus.rpc.util import ALL_TRANSLATION_LAYERS
from cactus.types.blockchain_format.coin import Coin as ConsensusCoin
...
from cactus.wallet.conditions import AggSigMe
from cactus.wallet.derivation_record import DerivationRecord
from cactus.wallet.derive_keys import _derive_path_unhardened
...
from cactus.wallet.util.blind_signer_tl import (
...
from cactus.wallet.util.clvm_streamable import (
    TranslationLayer,
...
async def test_p2dohp_wallet_signer_protocol(wallet_environments: WalletTestFramework) -> None:
    wallet: Wallet = wallet_environments.environments[0].cac_wallet
