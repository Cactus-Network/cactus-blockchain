...
async def test_nft_offer_with_fee(wallet_environments: WalletTestFramework) -> None:
    ...
    wallet_maker = env_0.cac_wallet
    wallet_taker = env_1.cac_wallet
    ...
    cac_request = 100
    maker_fee = uint64(10)
    offer_nft_for_cac: dict[int | bytes32, int] = {wallet_maker.id(): cac_request, nft_asset_id: -1}
    ...
    await wallet_environments.process_pending_states(
        [
            WalletStateTransition(
                ...
                post_block_balance_updates={
                    "cac": {
                        "unconfirmed_wallet_balance": -maker_fee + cac_request,
                        "confirmed_wallet_balance": -maker_fee + cac_request,
                        ">=#spendable_balance": 1,
                        ">=#max_send_amount": 1,
                        "pending_coin_removal_count": -1,
                        "unspent_coin_count": 1,
            ...
            WalletStateTransition(
                pre_block_balance_updates={
                    "cac": {
                        "unconfirmed_wallet_balance": -(cac_request + taker_fee),
                ...
                post_block_balance_updates={
                    "cac": {
                        "confirmed_wallet_balance": -(cac_request + taker_fee),
                        ">=#spendable_balance": 1,
                        ">=#max_send_amount": 1,
                        "<=#pending_change": -1,
                        "pending_coin_removal_count": -1,
    ...
    cac_offered = 1000
    maker_fee = uint64(10)
    offer_cac_for_nft: dict[int | bytes32, int] = {wallet_maker.id(): -cac_offered, nft_to_buy_asset_id: 1}
    ...
    await wallet_environments.process_pending_states(
        [
            WalletStateTransition(
                pre_block_balance_updates={
                    "cac": {
                        "<=#spendable_balance": -(cac_offered + maker_fee),
                        "<=#max_send_amount": -(cac_offered + maker_fee),
                        "pending_coin_removal_count": 1,
                    },
                    "nft": {},
                },
                post_block_balance_updates={
                    "cac": {
                        "unconfirmed_wallet_balance": -(cac_offered + maker_fee),
                        "confirmed_wallet_balance": -(cac_offered + maker_fee),
                        ">=#spendable_balance": 1,
                        ">=#max_send_amount": 1,
                        "pending_coin_removal_count": -1,
                    },
            ...
            WalletStateTransition(
                pre_block_balance_updates={
                    "cac": {
                        "unconfirmed_wallet_balance": -taker_fee + cac_offered,
                        "<=#spendable_balance": -(cac_offered + maker_fee),
                        "<=#max_send_amount": -(cac_offered + maker_fee),
                        ">=#pending_change": 1,
                        "pending_coin_removal_count": 1,
                ...
                post_block_balance_updates={
                    "cac": {
                        "confirmed_wallet_balance": -taker_fee + cac_offered,
                        ">=#spendable_balance": 1,
                        ">=#max_send_amount": 1,
                        "<=#pending_change": -1,
                        "pending_coin_removal_count": -1,
...
async def test_nft_offer_cancellations(wallet_environments: WalletTestFramework) -> None:
    ...
    cac_request = 100
    maker_fee = uint64(10)
    offer_nft_for_cac: dict[bytes32 | int, int] = {wallet_maker.id(): cac_request, nft_asset_id: -1}
    ...
    await wallet_environments.process_pending_states(
        [
            WalletStateTransition(
                pre_block_balance_updates={
                    "cac": {
                        "<=#spendable_balance": -(maker_fee + maker_cac_offered),
                        "<=#max_send_amount": -(maker_fee + maker_cac_offered),
                        "pending_coin_removal_count": 1,
                    },
                    "taker cat": {},
                    "nft": {
                ...
                post_block_balance_updates={
                    "cac": {
                        "unconfirmed_wallet_balance": -(maker_fee + maker_cac_offered),
                        "confirmed_wallet_balance": -(maker_fee + maker_cac_offered),
                        ">=#spendable_balance": 1,
                        ">=#max_send_amount": 1,
                        "pending_coin_removal_count": -1,
                    },
            ...
            WalletStateTransition(
                pre_block_balance_updates={
                    "cac": {
                        "unconfirmed_wallet_balance": -taker_fee + maker_cac_offered,
                        "<=#spendable_balance": -taker_fee + maker_cac_offered,
                        "<=#max_send_amount": -taker_fee + maker_cac_offered,
                        ">=#pending_change": 1,
                        "pending_coin_removal_count": 1,
                    },
                    "taker cat": {
                ...
                post_block_balance_updates={
                    "cac": {
                        "confirmed_wallet_balance": -taker_fee + maker_cac_offered,
                        ">=#spendable_balance": 1,
                        ">=#max_send_amount": 1,
                        "<=#pending_change": -1,
                        "pending_coin_removal_count": -1,
