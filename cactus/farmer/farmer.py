...
from cactus.pools.pool_config import PoolWalletConfig, load_pool_config
...
from cactus.util.config import load_config, save_config, config_path_for_filename
...
class Farmer:
    def __init__(
        ...
        if len(self.get_public_keys()) == 0:
            error_str = "No keys exist. Please run 'cactus keys generate' or open the UI."
        ...
        self.pool_target_encoded = pool_config["cac_target_address"]
    ...
    async def get_cached_harvesters(self, connection: WSCactusConnection) -> HarvesterCacheEntry:
