...
It is an input to the [cactus-blockchain](https://github.com/Cactus-Network/cactus-blockchain) repository which also includes a verifiable delay function implementation that it imports from the [cactusvdf repo](https://github.com/Cactus-Network/cactusvdf) (in c/c++), and a proof of space implementation that it imports from the [cactuspos repo](https://github.com/Cactus-Network/cactuspos). BLS signatures are imported from the [bls-signatures repo](https://github.com/Cactus-Network/bls-signatures) as blspy. There is an additional dependency on the [cactusbip158 repo](https://github.com/Cactus-Network/cactusbip158).
