...
import { AlertDialog } from '@cactus/core';
import {
  Typography,
  Button,
  Box,
...
import { cactus_to_mojo } from '../../../util/cactus';
...
export const CreateRLAdminWallet = () => {
  ...
  function create() {
    ...
    const cactusper = cactus_to_mojo(cactusper_input.value);
    ...
    // var fee = cactus_to_mojo(fee_input.value);
