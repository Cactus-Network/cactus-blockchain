...
import cactusConfig from '../util/config';
...
if (!handleSquirrelEvent()) {
  ...
  if (ensureSingleInstance() && ensureCorrectEnvironment()) {
    ...
    cactusConfig.loadConfig('mainnet');
    ...
    const createWindow = () => {
      ...
      if (!cactusConfig.manageDaemonLifetime()) {
      ...
      mainWindow.on('close', (e) => {
        ...
        if (decidedToClose || !cactusConfig.manageDaemonLifetime()) {
          return;
        }
        e.preventDefault();
        if (!isClosing) {
      ...
      },
      {
        ...
        submenu: [
          ...
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/Cactus-Network/cactus-blockchain/blob/master/CONTRIBUTING.md',
              );
            },
          },
          {
