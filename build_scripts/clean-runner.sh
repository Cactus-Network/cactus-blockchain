...
rm -rf ../venv || true
rm -rf venv || true
rm -rf cactus_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf cactus-blockchain-gui/build || true
rm -rf cactus-blockchain-gui/daemon || true
rm -rf cactus-blockchain-gui/node_modules || true
rm cactus-blockchain-gui/temp.json || true
( cd "$PWD/cactus-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
...
npm uninstall -g @cactus-network/notarize-cli || true
