...
Write-Output "Remove unused @cactus-network packages to make cache slim"
...
# Remove `packages/gui/node_modules/@cactus-network` to save cache space
#Remove-Item "@cactus-network" -Recurse -Force
