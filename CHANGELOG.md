...
- calccrypto/uint128_t was updated in the Windows chiapos implementation. Cactuspos required some changes its build process to support MacOS ARM64.
...
- We build both MacOS x86_64 and MacOS universal wheels for chiapos, chiavdf, blpsy, and cactusbip158 in Python 3.9. The universal build allows M1 Macs to run these dependencies in ARM64 native mode.
...
- There was a potential bug in Python 3.9.0 that required us to update blspy, chiapos, chiavdf, and cactusbip158.
...
- We added [lgtm](https://lgtm.com/) source analysis on pull request to the cactus-blockchain, chiapos, chiavdf, cactusbip158, and bls-library repositories to add some automated security analysis to our ci.
